...
client.on('message', message => {
  ...
  .addField('``سرعة أتصال الــبوت`` ' , `${Date.now() - message.createdTimestamp}` + ' ms`')
                 .setFooter(`Ninja™ BOT
 .`, 'https://cdn.discordapp.com/avatars/489787703223648266/ef953fddd1c4ea28f518cf5cfd803af3.png?size=2048')
...
client.on('guildMemberRemove', Sal => { //By Salto7#4595
  ...
  var channel =Sal.guild.channels.find('name', '𝐜𝐡𝐚𝐭') // هنا حط اسم الروم الي تبيه يكتب فيه
  if (!channel) return;
